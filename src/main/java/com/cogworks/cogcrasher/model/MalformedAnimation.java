...
public class MalformedAnimation {
    public static final AnimationDefinition MALFORMED_WALK = AnimationDefinition.Builder.withLength(1.125F)
        .looping()
        .addAnimation(
            "upper_body",
    ...
    public static final AnimationDefinition MALFORMED_ATTACK = AnimationDefinition.Builder.withLength(0.7083F)
        ...
        .build();
    public static final AnimationDefinition MALFORMED_INVULNERABLE = AnimationDefinition.Builder.withLength(0.2917F)
        .addAnimation(
            "upper_body",
            new AnimationChannel(
                AnimationChannel.Targets.ROTATION,
        ...
        .build();
    public static final AnimationDefinition MALFORMED_DEATH = AnimationDefinition.Builder.withLength(2.25F)
        .addAnimation(
            "upper_body",
            new AnimationChannel(
                AnimationChannel.Targets.ROTATION,
